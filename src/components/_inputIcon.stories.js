    ...
    Section(
        ...
        `
            <div class="sgbp-inputIcon sgbp-inputIcon--small">
              ...
              <svg class="sgbp-inputIcon__icon sgbp-icon"><use href="./assets/icons.svg#calendar"></use></svg>
    ...
    Section(
        ...
        `
            <div class="sgbp-inputIcon">
              ...
              <svg class="sgbp-inputIcon__icon sgbp-icon"><use href="./assets/icons.svg#visibility-on"></use></svg>
              <div class="sgbp-inputIcon__tooltip">
                Tooltip content
              </div>
            </div>
...
export const textarea = () => `
    <div class="sgbp-inputIcon sgbp-inputIcon--textarea">
      ...
      <svg class="sgbp-inputIcon__icon sgbp-icon sgbp-icon--tiny"><use href="./assets/icons.svg#check"></use></svg>
      <div class="sgbp-inputIcon__tooltip">
        Tooltip content<br>
