...
export default {
    title: 'Icons',
    decorators: [DescriptionDecorator(['If you need to support Internet Explorer, please also add <a class="sgbp-link" href="https://github.com/jonathantneal/svg4everybody" target="_blank" rel="noopener">svg4everybody</a>.'])]
}
...
export const AvailableIcons = () => `
    ...
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#folder-shared-open"></use></svg>
    ...
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#help"></use></svg>
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#house"></use></svg>
    ...
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#list-check"></use></svg>
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#map"></use></svg>
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#mood-positive"></use></svg>
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#mood-neutral"></use></svg>
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#mood-negative"></use></svg>
    ...
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#photo-camera"></use></svg>
    ...
    <svg class="sgbp-icon sgbp-icon--hoverAccent"><use xlink:href="./assets/icons.svg#warning"></use></svg>
`;
...
export const colors = () => Sections([
    ...
    Section(
        'Light',
        `<svg class="sgbp-icon sgbp-icon--light"><use xlink:href="./assets/icons.svg#check"></use></svg>`
    ),
    Section(
        'Warning',
        `<svg class="sgbp-icon sgbp-icon--warning"><use xlink:href="./assets/icons.svg#warning"></use></svg>`
    ),
    Section(
        'Error',
        `<svg class="sgbp-icon sgbp-icon--error"><use xlink:href="./assets/icons.svg#error"></use></svg>`
    ),
    Section(
        'Inverted',
        `
...
export const withCircle = () => `
    <div class="sgbp-region sgbp-region--default">
      ...
      <svg class="sgbp-icon sgbp-icon--circle sgbp-icon--warning"><use xlink:href="./assets/icons.svg#arrow-right"></use></svg>
      <svg class="sgbp-icon sgbp-icon--circle sgbp-icon--error"><use xlink:href="./assets/icons.svg#arrow-right"></use></svg>
    </div>
