...
export default {
    ...
    decorators: [DescriptionDecorator(['Paragraphs have a defined line height and bottom margin'])],
}


export const Standard = () => `
    <div class="sgbp-paragraph">
...
export const noMargin = () => `
    <div class="sgbp-paragraph sgbp-paragraph--noMargin">
